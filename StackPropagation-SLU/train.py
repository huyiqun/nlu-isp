...
# Training parameters.
parser.add_argument('--data_dir', '-dd', type=str, default='./StackPropagation-SLUdata/atis')
parser.add_argument('--save_dir', '-sd', type=str, default='./StackPropagation-SLUdata/atis/save')
